...
const styles = StyleSheet.create({
  ...
  welcomeTitle: { fontSize: 18, fontWeight: "700", color: Theme.colors.mutedForeground, marginBottom: 2 },
  welcomeName: { fontSize: 22, fontWeight: "800", color: Theme.colors.foreground, marginBottom: 4 },
  welcomeSubtitle: { fontSize: 13, color: Theme.colors.mutedForeground, marginBottom: 12 },
  ...
  headerBtnOutlineText: { fontSize: 12, fontWeight: "600", color: Theme.colors.textBody },
  headerBtnFilled: {
    flexDirection: "row", alignItems: "center",
  ...
  sectionSubtitle: { fontSize: 12, color: Theme.colors.mutedForeground, marginTop: 2, marginBottom: 16 },
  ...
  // Tips
  tipRow: { flexDirection: "row", alignItems: "center", paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: Theme.colors.muted },
  tipText: { fontSize: 12, color: Theme.colors.textBody, flex: 1 },
  ...
  fullHistoryText: { fontSize: 13, fontWeight: "600", color: Theme.colors.textBody },
});