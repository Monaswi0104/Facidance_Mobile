...
const createStyles = (colors) => StyleSheet.create({
  ...
  addFormInput: { height: 54, backgroundColor: colors.secondary, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 13, color: colors.foreground, borderWidth: 1, borderColor: colors.border },
  ...
  detailStatsRow: { flexDirection: "row", backgroundColor: colors.secondary, borderRadius: 10, marginVertical: 12, borderWidth: 1, borderColor: colors.border },
