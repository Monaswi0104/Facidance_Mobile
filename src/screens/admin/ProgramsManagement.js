...
const styles = StyleSheet.create({
  ...
  progRowBorder: { borderBottomWidth: 1, borderBottomColor: "#F1F5F9" },
  ...
  progName: { fontSize: 13, fontWeight: "700", color: "#0F172A" },
  progMeta: { fontSize: 10, color: "#94A3B8", marginRight: 6 },
  progIdBadge: { backgroundColor: "#F1F5F9", paddingHorizontal: 6, paddingVertical: 1, borderRadius: 4 },
  progIdText: { fontSize: 8, fontWeight: "700", color: "#94A3B8", letterSpacing: 0.3 },
  ...
  detailStatsRow: { flexDirection: "row", backgroundColor: "#F8FAFC", borderRadius: 10, marginVertical: 12, borderWidth: 1, borderColor: "#E2E8F0" },
